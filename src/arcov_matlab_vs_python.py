...
Test our python arcov vs the MatlabTM arcov
...
if __name__ == '__main__':
    ...
    # Get matlab output of arcov
    matlab_a = matlab.get('a')
    matlab_e = matlab.get('e')

     
    # Use same inputs on python arcov
    [py_a, py_e] = arcov(matlab_x, 2*matlab_p)
